---
title: "Как понять, зарегистрирован ли ИИ-инструмент как медицинское изделие"
description: "Постановление №1684 задаёт правила и сроки регистрации медицинских изделий, включая ПО на основе ИИ. Разбираем, что это значит на практике и сколько времени занимает процедура."
pubDate: 2026-08-13
category: "Колонка"
draft: false
---

---
title: "152-ФЗ и локализация данных: что проверить перед внедрением ИИ в больнице"
description: "Прежде чем подключать ИИ-сервис к работе с данными пациентов, стоит проверить два требования 152-ФЗ: где физически хранятся данные и когда нужно письменное согласие. Разбираем на практических примерах."
pubDate: 2026-08-13
category: "Колонка"
draft: true
---

...
const SITE_ID = 'Hospital AI Lab';
const DESC_ID =
  'Kolom tentang AI kesehatan di rumah sakit — pelindungan data pribadi, perizinan alat kesehatan, dan arah regulasi di Indonesia.';
...
export async function GET(context) {
  ...
  return rss({
    title: SITE_ID,
    description: DESC_ID,
    stylesheet: `${BASE}/id/rss-styles.xsl`,
    site: new URL(`${BASE}/id/`, context.site).href,
    items,
    ...
    customData: [
      ...
      `<atom:link href="${new URL(`${BASE}/id/rss.xml`, context.site).href}" rel="self" type="application/rss+xml"/>`,

...
const DESC_RU =
  'Колонки о регулировании медицинского ИИ в России — регистрация медицинских изделий, требования к персональным данным, новое законодательство.';
...
export async function GET(context) {
  ...
  return rss({
    title: SITE_RU,
    description: DESC_RU,
    stylesheet: `${BASE}/ru/rss-styles.xsl`,
    site: new URL(`${BASE}/ru/`, context.site).href,
    items,
    ...
    customData: [
      ...
      `<atom:link href="${new URL(`${BASE}/ru/rss.xml`, context.site).href}" rel="self" type="application/rss+xml"/>`,

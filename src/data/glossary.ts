...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    whyMatters:
      "제안서의 성능을 한 숫자로 비교할 때 가장 많이 등장합니다. 개발사 자체 시험에서 높게 나온 값이 우리 병원 환자군에서는 떨어질 수 있으므로(예: 한 상용 패혈증 예측 모델이 외부검증(다른 병원 데이터로 다시 평가하는 것)에서 AUROC 0.63으로 하락한 사례) '어떤 환자에서, 누가 검증했는지'를 함께 물어야 합니다.",
    source: 'https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2781307',
  },
  {
    term: '정밀도',

...
//
// '전시'·KHF 추가 (2026-08-20, 오너 지시로 행사 수집 정체 원인 조사 후):
// 실측 결과 events.json이 8/15부터 5일간 갱신이 없었는데, 원인은 크롤러
// 오류가 아니라 이 조건이 지나치게 좁아서였다(메디칼타임즈·병원신문 원본
// 110건 확인, 크롤러는 정상 작동). 특히 KHF(국제병원의료산업박람회) 관련
// 기사가 "AI 'CLIC' 전시", "의료 AI 풀스택 전격 공개"처럼 '전시회'가 아닌
// '전시'(동사형)를 써서 전부 빠지고 있었다. '전시'와 행사명 'KHF'를 더해
// 이 교집합을 잡는다. '소개'·'공개'·'제시'처럼 아주 흔한 동사는 일반
// 기사에도 널려 있어(오탐 위험) 넣지 않았다.
const EVENT_RE =
  /교육|세미나|컨퍼런스|콘퍼런스|학술대회|심포지엄|워크숍|워크샵|포럼|설명회|강좌|연수|아카데미|박람회|전시회|전시|웨비나|공청회|토론회|간담회|개최|KHF/;
